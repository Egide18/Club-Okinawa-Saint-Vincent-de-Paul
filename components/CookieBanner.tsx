...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[60] p-3 sm:p-5" role="dialog" aria-label="Consentement cookies">
      <div className="mx-auto flex max-w-4xl flex-col gap-4 rounded-2xl border border-white/15 bg-dojo-900/95 p-5 shadow-2xl shadow-black/60 backdrop-blur-xl sm:flex-row sm:items-center">
