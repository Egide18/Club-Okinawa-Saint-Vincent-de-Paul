...
| Page | Contenu |
|---|---|
| **Accueil** | Karatéka animé entrant dans le dojo, slogan + paragraphe modifiables, slider de textes, chiffres clés, slider auto des partenaires |
...
| **Inscription** | Instructions obligatoires + case « **Lu et approuvé** » → formulaire → **page de vérification** (modifier/remplacer) → notification de validation. Fichiers JPG/PNG/PDF ≤ 5 Mo |
| **Contact** | Formulaire + bouton **WhatsApp** relié au numéro du club |
| **Admin** | Connexion glassmorphisme sur fond 4K, mot de passe **bcrypt**, tableau de bord : galerie (upload direct), inscriptions, messages, **logs de connexion** (date/heure/IP/appareil), réglages du site |
