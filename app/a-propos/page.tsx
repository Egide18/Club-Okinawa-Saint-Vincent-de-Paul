...
export default async function AProposPage() {
  ...
  return (
    <>
      ...
      {/* ─── Sensei ─── */}
      <section className="themed dojo-bg relative py-16">
      ...
      <section className="themed dojo-bg relative py-20">
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <Reveal variant="zoom">
            <div className="keep-dark relative overflow-hidden rounded-3xl border border-karate-gold/30 bg-gradient-to-b from-karate-darkred/60 to-black p-10 text-center shadow-2xl shadow-karate-red/10">
