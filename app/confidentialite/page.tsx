...
export default function Confidentialite() {
  return (
    <section className="themed dojo-bg relative pb-24 pt-36">
        ...
        <Reveal delay={150}>
          <article className="mt-8 space-y-6 rounded-3xl border border-white/10 bg-white/[0.03] p-6 text-sm leading-relaxed text-stone-300 sm:p-10">
            ...
            <div>
              ...
              <ul className="mt-2 list-disc space-y-1 pl-5">
                <li>Gestion des pré-inscriptions et des dossiers de candidats — <em>consentement + mesures précontractuelles</em>.</li>
            ...
            <div>
              ...
              <p className="mt-2">
                La pré-inscription des mineurs (7–17 ans) est effectuée sous l’autorité du responsable légal,
                dont l’identité est recueillie dans le formulaire. Les parents peuvent demander à tout moment
                l’accès ou la suppression des données de leur enfant.
              </p>
            </div>
          </article>
        </Reveal>
